    ...
    Plugin.prototype = {
            ...
            if (self.enabled && self.content !== null) {
                if (self.options.onlyOne) {
                    $(".tooltipstered").not(self.$el).each(function(i, el) {
                        var $el = $(el), s = $el[pluginName]("status"), ac = $el[pluginName]("option", "autoClose");
                    ...
                    if (self.status !== "hidden") {
                        ...
                        if (self.status === "disappearing") {
                            ...
                            if (supportsTransitions()) {
                                ...
                                self.$tooltip.stop().fadeIn(function() {
                                    self.status = "shown";
                                });
                            }
                        }
            ...
            self.checkInterval = setInterval(function() {
                if ($("body").find(self.$el).length === 0 || $("body").find(self.$elProxy).length === 0 || self.status == "hidden" || $("body").find(self.$tooltip).length === 0) {
                    ...
                    if (self.options.positionTracker) {
                        var p = self.positionInfo(self.$elProxy), identical = false;
        ...
        positionTooltip: function() {
            ...
            if ($("body").find(self.$tooltip).length !== 0) {
                ...
                var arrowReposition = null, windowWidth = $(window).width(), proxy = self.elProxyPosition, tooltipWidth = self.$tooltip.outerWidth(false), tooltipInnerWidth = self.$tooltip.innerWidth() + 1, tooltipHeight = self.$tooltip.outerHeight(false), resetPosition = null;
                    ...
                    if (self) {
                        switch (args[0]) {
                          ...
                          case "destroy":
                            ...
                            self.$el.removeClass("tooltipstered").attr("title", stringifiedContent).removeData("tooltipster").off("." + self.namespace);
                            break;
